...
```{r scalesday, fig.height=0.8}
ggplot() + theme_classic() + theme(axis.line.x=element_line(), plot.margin=unit(c(1,2,1,2),"lines")) +
  scale_x_continuous(name="Day", breaks=1:7, limits=c(1,7), minor_breaks=NULL,
...
ggplot() + theme_classic() + theme(axis.line.x=element_line(), axis.ticks.x=element_line(), plot.margin=unit(c(1,2,1,2),"lines")) +
